...
See the [working "Abbreviation (Custom Plugin with Dialog, Context Menu and ACF Support)" sample](../samples/abbr.html) that shows the final version of the Abbreviation plugin integrated with an editor instance.
