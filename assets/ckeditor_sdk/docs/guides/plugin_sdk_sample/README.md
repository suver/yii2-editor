...
See the [working "Timestamp (Creating a Most Basic CKEditor Plugin)" sample](../samples/timestamp.html) that shows the Timestamp plugin integrated with an editor instance.
